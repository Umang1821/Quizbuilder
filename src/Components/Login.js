  ...
  return (
    ...
    >
      <div className="container">
        <p className="h2 text-black text-center  p-3 ">
          Welcome to Quiz Builder Application
        </p>
        <div className="col-md-6 align-middle" style={{ marginTop: "10px" }}>
          <div className="mb-2 text-center">
            <p className="h3 black text-center opacity-75">
          ...
          <div>
            <p className="h5 text-black mt-2">Don't have an Account ?</p>
            <Link to="/Register">
