...
import userhome_bg from "./assets/user.jpg";
          ...
          <div className="row p-5">
            <div className="col bg-light mt-5" style={{ opacity: "90%" }}>
              <div className="fw-bold fs-3 text-center">
                Welcome to Quiz Builder Application. Here you can create and
                view your quizes.
              </div>
              <div className="d-flex flex-column justify-content-center my-4">
                <button className="btn btn-primary">
                  <Link
                    to={`/UserHome/QuestionInput`}
            ...
            {/* <div className="col bg-light text-center opacity-75 mt-5">
              <div className="">
                <label className="form-label fw-bold h3">
                  Enter Permalink of Quiz
                </label>
                <input
            ...
            <div>
              <button
                className="btn btn-outline-dark rounded-pill m-2 float-middle"
                onClick={logout}
              >
                Logout
              </button>
